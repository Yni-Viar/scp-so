...
public partial class MapGenerator : Node
{
    ...
    public async Task CreateMap()
    {
        ...
        */
        ...
        MapRoom[(int)RoomType.ROOM1, Room1Amount[0]+Mathf.FloorToInt(0.1f*Room1Amount[1])] = "LC_room1_archive";

        SetRoom(ref MapRoom, "LC_cont1_079", RoomType.ROOM1, Room1Amount[0]+Mathf.FloorToInt(0.3f * Room1Amount[1]), min_pos, max_pos);
    ...
    {
        Room room = new Room();
        Node3D go = (Node3D)room.GetRoomMesh(room_name, type, zone).Instantiate(); //Instantiate(room.gameObject, transform);
